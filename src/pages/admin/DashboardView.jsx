...
const MOCK_TICKETS = [
  {
    id: 1,
    code: 'TKT-2026-ZBYPIG',
    subject: 'Unclean restroom, 2nd floor',
    ...
    updated_at: '2026-04-30T02:26:00Z',
    description: 'The 2nd floor restroom is very dirty.',
    resolutionNotes: '',
    resolutionDate: null,
    resolvedBy: null,
    history: [
      { action: 'Ticket Submitted', details: '', date: '2026-04-30T01:00:00Z', performedBy: 'system' }
    ]
  },
  {
    id: 2,
    code: 'TKT-2026-002',
    subject: 'Broken air conditioner',
    category: 'Equipment',
    status: 'in_progress',
    priority: 'high',
    assignedTo: 'Mr. Cruz',
    ...
    resolutionNotes: 'Technician scheduled.',
    resolutionDate: null,
    resolvedBy: null,
    history: []
  },
  {
    ...
    resolutionNotes: 'Router replaced.',
    resolutionDate: '2026-04-28T10:00:00Z',
    resolvedBy: 'Ms. Reyes',
    history: []
  }
];

const MOCK_STATS = { total: 20, needAction: 8, inProgress: 7, resolved: 5 };
...
export default function DashboardView() {
  ...
  const statCards = [
    ...
    { title: 'Open', value: stats.needAction, subtitle: 'Need Action', circleColor: '#0D457D', numberColor: '#0D457D', bgColor: '#E6F1FB' },
